...
pairs(~ Sales + Temperature + Fuel_Price + CPI + Unemployment, data = store.level, main = "PairWise Plot1")
pairs(~ Sales + MarkDown1 + MarkDown2 + MarkDown3 + MarkDown4 + MarkDown5, data = store.level, main = "PairWise Plot2")
require(GGally)
ggpairs(store.level[,c("Sales", "CPI", "Unemployment")],
        title="Correlation Matrix for Macro Indicators") 
ggpairs(store.level[,c("Sales", "MarkDown1", "MarkDown2", "MarkDown3", "MarkDown4","MarkDown5")], title="Correlation Matrix for MarkDowns") 
```
