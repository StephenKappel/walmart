...
TODO: formula <- Norm_Weekly_Sales ~ Norm_Unemployment + IsHoliday*Store_Type + Store_Size

### Model comparison

TODO: linear, KNN, tree

TODO: stepwise selection to find most significant predictors; show that the training error keeps going down, but test error increases as some critical point
